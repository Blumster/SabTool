...
namespace SabTool.Data.GameTemplatesOld
{
    ...
    public class GameTemplatesDump : GameTemplatesBase
    {
        ...
        private static Dictionary<TypeCrcKey, TypeEntry> PropertyTypes { get; } = new()
        {
            ...
            { new(0x92473A24, 0xFB31F1EF), new(null, typeof(Crc)) },
            ...
            { new(0x92473A24, 0x4A67BCC0), new(null, typeof(Crc)) },
            { new(0x92473A24, 0x4D44EFE0), new(null, typeof(Crc)) },
            ...
            { new(0x92473A24, 0x5E58EAC8), new(null, typeof(Crc)) },
            ...
            { new(0x92473A24, 0x30C712EE), new(null, typeof(Color)) },
