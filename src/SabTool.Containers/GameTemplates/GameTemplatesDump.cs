...
namespace SabTool.Containers.GameTemplates
{
    ...
    public class GameTemplatesDump : GameTemplatesBase
    {
        ...
        private static Dictionary<string, HashSet<string>> Parents { get; } = new()
        {
            ...
            { "Vehicle", new() { "ModelRenderable", "Damageable", "LightAttachement", "LightHaloAttachment", "Audible", "PhysicsVehicle", "Trappable", "GunnerSeat", "Aimer", "AttrPtAttachable", "TweakableColors", "Seat", "SearcherSeat" } },
